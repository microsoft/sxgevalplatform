namespace SxG.EvalPlatform.Plugins.Models.Responses
{
    ...
    /// <summary>
    /// Response model for UpdateEnrichedDatasetFile Custom API (standardized format)
    /// </summary>
    public class UpdateEnrichedDatasetFileResponse
    {
        /// <summary>
        /// Indicates if the operation was successful
        /// </summary>
        ...
        /// </summary>
        /// <returns>Success response</returns>
        public static UpdateEnrichedDatasetFileResponse CreateSuccess()
        {
            return new UpdateEnrichedDatasetFileResponse
            {
                Success = true,
        ...
        /// <param name="evalRunId">Eval run ID</param>
        /// <returns>Error response</returns>
        public static UpdateEnrichedDatasetFileResponse CreateError(string message, string evalRunId = null)
        {
            return new UpdateEnrichedDatasetFileResponse
            {
                Success = false,
