...
<#
.SYNOPSIS
    Complete Azure AI Foundry Setup for East US 2 Production
.DESCRIPTION
...
$AIHubName = "evalplatformhubprodeus2"
$AIProjectName = "evalplatformprojectprod"
$StorageAccountName = "foundryeus2prod"
$KeyVaultName = "foundry-kv-eus2-prod"
$AppInsightsName = "eval-runner-prod-app-insights"

# Azure OpenAI Resources
$OpenAIName = "evalplatformopenai-prod-eus2"
$OpenAIDeploymentName = "gpt-4"
$OpenAIModelName = "gpt-4"
$OpenAIModelVersion = "turbo-2024-04-09"

# Container App
$ContainerAppName = "eval-runner-prod-eus2"
...
$LogFile = "foundry-setup-eastus2-${Timestamp}.log"
...
"@
    ...
    Write-Log "2. Update appsettings.Production-EastUS2.json with:" "INFO"
