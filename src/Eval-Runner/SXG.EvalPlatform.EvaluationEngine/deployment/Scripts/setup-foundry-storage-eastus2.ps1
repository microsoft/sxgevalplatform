...
<#
.SYNOPSIS
    Setup Azure Foundry Storage Account for East US 2 Production
.DESCRIPTION
    Creates and configures a dedicated storage account for Azure AI Foundry (East US 2)
...
$Region = "East US 2"
$Location = "eastus2"
$ResourceGroup = "EvalRunnerRG-EastUS2"  # Match regional resource group name
$StorageAccountName = "foundryeus2prod"  # Max 24 chars, lowercase, no hyphens
$AIFoundryProjectName = "evalplatformprojectproduseast2"
$ContainerAppName = "eval-runner-prod-eus2"  # Match shortened container app name
...
$LogFile = "foundry-storage-setup-eastus2-${Timestamp}.log"
...
try {
    ...
    Write-Log "" "INFO"
    Write-Log "Retrieving Container App Managed Identity..." "INFO"
