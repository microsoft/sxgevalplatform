...
namespace Sxg.EvalPlatform.API.Storage.Services
{
    ...
    /// </summary>
    public class AzureBlobStorageServiceV2 : IStorageProviderService
    {
        ...
        /// <inheritdoc />
        public async Task<string?> ReadAsync(string containerName, string blobName)
        {
            try
            {
        ...
        /// <inheritdoc />
        public async Task<bool> WriteAsync(string containerName, string blobName, string content)
        {
            try
            {
        ...
        /// <inheritdoc />
        public async Task<List<string>> ListAsync(string containerName, string prefix)
        {
            try
            {
