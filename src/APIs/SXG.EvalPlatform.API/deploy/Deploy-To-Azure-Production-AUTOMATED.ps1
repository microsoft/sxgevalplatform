...
Write-Host "SXG Evaluation Platform API" -ForegroundColor Red
Write-Host "PRODUCTION DEPLOYMENT - CONFIRMATION REQUIRED" -ForegroundColor Red
Write-Host "========================================" -ForegroundColor Red
Write-Host ""
Write-Host "??  WARNING: YOU ARE DEPLOYING TO PRODUCTION ??" -ForegroundColor Red
Write-Host ""
Write-Host "Target App Service: $AppName" -ForegroundColor Yellow
Write-Host "Resource Group: $ResourceGroupName" -ForegroundColor Yellow
Write-Host "Storage Account: $StorageAccountName" -ForegroundColor Yellow
Write-Host ""

# PRODUCTION CONFIRMATION REQUIRED
Write-Host "Type 'PRODUCTION' to confirm deployment: " -ForegroundColor Red -NoNewline
$confirmation = Read-Host
if ($confirmation -ne "PRODUCTION") {
    Write-Host "? Deployment cancelled. Confirmation did not match." -ForegroundColor Yellow
    exit 0
}
Write-Host "? Production deployment confirmed" -ForegroundColor Green
Write-Host ""
...
Write-Host "[5/12] Reading and deploying App Settings from appsettings.json..." -ForegroundColor Yellow

try {
    $appSettings = Get-MergedAppSettings -Environment "Production" -StorageAccountName $StorageAccountName
...
if ($healthResult.Success) {
    ...
    Write-Host "?? PRODUCTION DEPLOYMENT COMPLETED WITH WARNINGS" -ForegroundColor Yellow
